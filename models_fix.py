...
class Resident(models.Model):
    ...
    civil_status = models.CharField(max_length=20, choices=CIVIL_CHOICES, blank=True, default='')
    citizenship = models.CharField(max_length=20, choices=CITIZENSHIP_CHOICES, default='Filipino')
    ...
    lgbtq_type = models.CharField(max_length=20, choices=LGBTQ_CHOICES, blank=True, default='')
...
class MedicalStaff(models.Model):
    ...
    name = models.CharField(max_length=100)
    position = models.CharField(max_length=50, choices=POSITION_CHOICES, default='Health Worker')
    contact_number = models.CharField(max_length=20, blank=True, default='')
...
class OtherProfessional(models.Model):
    ...
    name = models.CharField(max_length=100)
    profession = models.CharField(max_length=50, choices=PROFESSION_CHOICES, default='Teacher')
    contact_number = models.CharField(max_length=20, blank=True, default='')
...
# ============================================================
# BARANGAY SETTINGS MODEL (RENAMED)
# ============================================================
